...
# %% auto #0
__all__ = ['htmx4src', 'empty', 'Partial', 'def_hdrs', 'fast_app', 'sse_message']
...
# %% ../nbs/00_core.ipynb #ea8af339
# Patch for htmx v4 WebSocket: headers key is lowercase 'headers' instead of 'HEADERS'
def _wrap_ws_patch(ws, data, params):
